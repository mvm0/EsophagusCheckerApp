...
def fcn(input_shape=(256, 256, 3), num_classes=1):
    ...
    block6_conv1 = Conv2D(512, 3, activation='relu', padding='same')(block6_up)
    ...
    block7_conv1 = Conv2D(256, 3, activation='relu', padding='same')(block7_up)
    ...
    block8_conv1 = Conv2D(128, 3, activation='relu', padding='same')(block8_up)
    ...
    block9_conv1 = Conv2D(64, 3, activation='relu', padding='same')(block9_up)
